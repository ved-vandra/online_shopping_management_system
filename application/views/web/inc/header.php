    ...
    <div class="wrap">
        <div class="header_top">
            ...
            <div class="header_top_right">
                ...
                if ($customer_id) {
                    ?>
                    <div class="login"><a href="<?php echo base_url('/customer/logout'); ?>">Logout</a></div> <br>
                <?php } else {
                    ?>
                    
                    <a href="<?php echo base_url('/customer/login'); ?>"><button type="button" class="btn btn-outline-dark">Login</button></a>
